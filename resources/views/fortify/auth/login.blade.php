                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="remember-me" aria-describedby="remember-me" type="checkbox" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800" checked>
                            </div>
                            <div class="ml-3 text-sm">
                                <label for="remember-me" class="text-gray-500 dark:text-gray-300">Remember me</label>
                            </div>
                        </div>
